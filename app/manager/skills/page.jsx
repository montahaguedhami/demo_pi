...
export default function ManagerSkillsPage() {
    ...
    const skillGaps = [
        { name: "Cloud Infrastructure", gap: -25, critical: true, teamAvg: 42, target: 75 },
        { name: "Python Core", gap: -15, critical: false, teamAvg: 58, target: 80 },
        { name: "System Architecture", gap: -30, critical: true, teamAvg: 35, target: 70 },
        { name: "Data Analysis", gap: -20, critical: false, teamAvg: 50, target: 75 },
    ]

    const topSkills = [
        { name: "Leadership", avg: 82, employees: 14 },
        { name: "Communication", avg: 78, employees: 12 },
        { name: "Project Management", avg: 74, employees: 10 },
    ]
                                    ...
                                    <div className="flex items-center justify-between mb-3">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-[11px] text-slate-400 font-medium">Team: {gap.teamAvg}% Â· Benchmark: {gap.target}%</p>
                                            </div>
                                        </div>
                                        <div className="text-right">
                                            ...
                                            <p className="text-[10px] font-bold text-slate-300 uppercase tracking-wider leading-none">Gap</p>
                                        </div>
                                    </div>
