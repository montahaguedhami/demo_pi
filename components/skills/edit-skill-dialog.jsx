            ...
            <DialogContent className="max-w-xl bg-white border-none rounded-[4px] p-0 overflow-hidden shadow-2xl flex flex-col max-h-[90vh]">
                ...
                <div className="bg-[#222222] px-10 py-10 relative overflow-hidden group shrink-0">
                    ...
                    <DialogHeader className="relative z-10">
                        <p className="text-[9px] font-bold text-[#F28C1B] uppercase tracking-[0.4em] mb-3">Refinement Protocol</p>
                    ...
                    <form id="edit-skill-form" onSubmit={handleSubmit} className="px-10 py-10 space-y-8">
                        ...
                        <div className="space-y-3">
                            ...
                            <Textarea
                                ...
                                className="min-h-[160px] bg-[#EEEEEE] border-none rounded-[4px] p-6 text-[11px] font-bold text-[#222222] uppercase tracking-widest placeholder:text-gray-300 focus-visible:ring-1 focus-visible:ring-[#F28C1B] italic leading-relaxed"
                            />
                        </div>
                    </form>
                </div>
