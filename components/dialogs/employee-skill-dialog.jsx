      ...
      <DialogContent className="max-w-[450px] bg-white border-none rounded-[4px] p-0 overflow-hidden shadow-2xl flex flex-col max-h-[90vh]">
        ...
        <div className="bg-[#222222] px-10 py-10 relative overflow-hidden group shrink-0">
          ...
          <DialogHeader className="relative z-10 text-left">
            <p className="text-[9px] font-bold text-[#F28C1B] uppercase tracking-[0.4em] mb-3">Calibration Protocol</p>
            ...
            <div className="grid gap-8">
              {mode === "add" && (
                <div className="grid gap-3">
                  <Label htmlFor="skill" className="text-[10px] font-black text-gray-400 uppercase tracking-widest italic ml-1">Target Capability *</Label>
                  <Select value={selectedSkillId} onValueChange={setSelectedSkillId}>
                    ...
                    <SelectContent className="bg-white border-slate-200 rounded-[4px] shadow-2xl">
                      {availableSkills.map((skill) => (
                        <SelectItem key={skill.id} value={skill.id} className="font-bold text-[10px] uppercase italic">
                          {skill.name}
                        </SelectItem>
                      ))}
                    </SelectContent>
                  ...
                  {availableSkills.length === 0 && (
                    <p className="text-[9px] text-rose-500 font-black uppercase tracking-widest italic mt-1">
              ...
              <div className="space-y-6">
                <div className="flex justify-between items-end">
                  <Label className="text-[10px] font-black text-gray-400 uppercase tracking-widest italic ml-1">Proficiency Score</Label>
                  <span className="text-3xl font-black text-[#F28C1B] italic tracking-tighter">{score}%</span>
                </div>
                <Slider
                  value={[score]}
                ...
                <div className="p-6 rounded-xl bg-slate-50 border border-slate-100 flex items-center justify-between">
                  ...
                  <span className="text-[11px] font-black text-[#222222] uppercase tracking-widest italic">{getLevelDisplay(score)}</span>
                </div>
              </div>
              ...
              <div className="p-6 rounded-xl border-2 border-dashed border-slate-100 space-y-4">
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-[10px] font-black text-[#222222] uppercase tracking-widest italic">Capability Thresholds</p>
                </div>
