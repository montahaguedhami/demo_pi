    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[85vh] overflow-y-auto bg-white border-none rounded-[4px] p-0 shadow-2xl">
        <DialogHeader className="p-8 border-b border-[#EEEEEE]">
          <DialogTitle className="text-2xl font-bold text-[#222222] uppercase tracking-tighter">Self-Calibration Matrix</DialogTitle>
          <DialogDescription className="text-xs font-bold text-gray-400 uppercase tracking-widest mt-2 leading-relaxed">
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-8">
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between mb-6">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <span className="text-sm font-bold text-[#222222] uppercase tracking-tighter">{skillName}</span>
                          {skillInfo && (
                      ...
                      <div className="flex items-center gap-3">
                        <Badge variant="outline" className={cn("text-[10px] uppercase font-bold px-2 py-0.5 rounded-[2px]", getLevelColor(skill.level))}>
                          {skill.level}
                        </Badge>
                        <span className="text-gray-300 font-bold">→</span>
                        <Badge variant="outline" className={cn("text-[10px] uppercase font-bold px-2 py-0.5 rounded-[2px]", getLevelColor(newLevel))}>
                          {newLevel}
                        </Badge>
                      </div>
                    </div>
                    ...
                    <div className="space-y-6">
                      ...
                      <Textarea
                        ...
                        rows={1}
                        className="bg-[#EEEEEE] border-none rounded-[4px] py-3 text-[10px] font-bold text-[#222222] uppercase tracking-widest placeholder:text-gray-400 focus-visible:ring-2 focus-visible:ring-[#F28C1B] min-h-[40px] resize-none"
                      />
                    </div>
                  </CardContent>
                </Card>
          ...
          <div className="space-y-3 pt-4 border-t border-[#EEEEEE]">
            <Label htmlFor="overallFeedback" className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Final Synthesis</Label>
            <Textarea
              id="overallFeedback"
          ...
          <DialogFooter className="gap-3 pt-4">
            <Button
              ...
              className="px-8 font-bold text-gray-400 hover:text-[#222222] uppercase tracking-widest text-[10px]"
            >
              Abort Evaluation
            </Button>
            <Button
              type="submit"
              className="bg-[#F28C1B] hover:bg-[#D97812] text-white font-bold py-6 px-10 rounded-[4px] uppercase tracking-widest text-[10px] shadow-md transition-all active:scale-95"
            >
              Commit Calibration
            </Button>
          </DialogFooter>
