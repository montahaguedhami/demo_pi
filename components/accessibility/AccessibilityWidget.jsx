        ...
        <>
            ...
            >
                ...
                <div className="bg-[#222222] px-8 py-6 flex items-center justify-between">
                    <div>
                        <p className="text-[9px] font-bold text-[#F28C1B] uppercase tracking-[0.4em]">Assist Protocol</p>
                        <h2 className="text-lg font-black font-display text-white uppercase tracking-tighter italic leading-tight">
                            Accessibility
                        </h2>
                    </div>
                    <button
                        ...
                        className="flex items-center gap-2 text-[9px] font-bold text-gray-400 uppercase tracking-widest hover:text-[#F28C1B] transition-colors"
                    >
                ...
                <div className="p-6 space-y-3 max-h-[70vh] overflow-y-auto">
                    ...
                    <div className="bg-[#F8FAFC] border border-[#EEEEEE] rounded-[4px] p-5">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <span className="text-[10px] font-black font-display text-[#222222] uppercase tracking-widest">
                                Text Size
                            </span>
                            <span className="ml-auto text-[9px] font-bold text-[#F28C1B] uppercase tracking-widest italic">
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    <p className={cn(
                                        "text-[11px] font-black font-display uppercase tracking-widest leading-none mb-1",
